...
class ResNetMulti(nn.Module):
    def __init__(self, ResBlock, layer_list, num_classes, num_channels=3):
        ...
        self.layer3 = self._make_layer(ResBlock, layer_list[2], planes=256, stride=1, dilation=2)    # atrous convolution, conv4
        self.layer4 = self._make_layer(ResBlock, layer_list[3], planes=512, stride=1, dilation=4)    # atrous convolution, conv5
        self.layer5 = self._make_pred_layer(ASPP, 1024, num_classes, [6, 12, 18, 24], [6, 12, 18, 24])      #aspp1
        self.layer6 = self._make_pred_layer(ASPP, 2048, num_classes, [6, 12, 18, 24], [6, 12, 18, 24])      #aspp2
    ...
    def get_10x_lr_params(self):
        ...
        """
        b = [self.layer5.parameters(), self.layer6.parameters()]                    #The last layers have 10 times the learning rate of other layers.
...
def Segmentation(num_classes, channels=3):
    return ResNetMulti(Bottleneck, [3, 4, 23, 3], num_classes, channels)
