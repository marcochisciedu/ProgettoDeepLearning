...
DATA_LIST_PATH = '/tmp/pycharm_project_127/dataset/cityscapes_list/test.txt'
if MODEL == 'Adapt':
    SAVE_PATH = '/tmp/pycharm_project_127/result/cityscapes_test'
    RESTORE_FROM = '/tmp/pycharm_project_127/snapshots/GTA5_150000.pth'
elif MODEL == 'Deeplab':
    SAVE_PATH = '/tmp/pycharm_project_127/result_deeplabv2/cityscapes_test'
    RESTORE_FROM = '/tmp/pycharm_project_127/snapshots_deeplabv2/GTA5_20000.pth'

IGNORE_LABEL = 255
NUM_CLASSES = 19
NUM_STEPS = 1525  # Number of images in the test set.
SET = 'test'
